...
# The guardrail IS the tool list: attach ONLY read/query tools, no write/edit tools.
...
- State the permissions/DMVs you rely on (e.g. `VIEW SERVER STATE`) and note when
  something is blocked rather than guessing.
